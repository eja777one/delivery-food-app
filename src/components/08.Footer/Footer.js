    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles['policy-block']}>
                ...
                <div className={styles.rights}>© ООО СК «АПШЕРОН» Все права защищены. 2010-2020</div>
            ...
            <div className={styles['links-block']}>
                <a className={styles.link} href='#'>О ресторане</a>
                <a className={styles.link} href='#'>Условия доставки</a>
                <a className={styles.link} href='#'>Возврат товара</a>
