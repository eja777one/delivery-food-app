        ...
        <section className={styles.contacts}>
            <div className={styles['contacts-block']}>
                ...
                <div className={styles['adress-block']}>
                    <div><img src={locIcon} /></div>
                    <div className={styles.adress}>
                        <div className={styles['adress-text']}>Наш адрес:</div>
                        <div className={styles['adress-description']}>МО, городской округ Красногорск, село Ильинкое, Экспериментальная улица, 10</div>
                    </div>
                </div>
                <div className={styles['post-block']}>
                    ...
                    <div className={styles.post}>
                        ...
                        <div className={styles['post-description']} >auto.wash@gmail.com</div>
                    </div>
                </div>
                <div className={styles['contacts-section']}>
                    ...
                    <div>
                        ...
                        <div className={styles['number-text']}>Звоните или оставляйте заявку</div>
                    </div>
                </div>
                <div className={styles['social-block']}>
                    <div className={styles['social-text']}>Мы в соц сетях:</div>
                    <a className={styles['social-icon']} href='#'><img src={fb} /></a>
                    <a className={styles['social-icon']} href='#'><img src={vk} /></a>
                    <a className={styles['social-icon']} href='#'><img src={youtube} /></a>
                    <a className={styles['social-icon']} href='#'><img src={instagram} /></a>
                </div>
            </div>
        </section>
    )
